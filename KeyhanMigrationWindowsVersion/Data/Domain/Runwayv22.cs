...
public partial class Runwayv22
{
    ...
    public string RunwayAccuracyComplianceFlag { get; set; } = null!;

    public string LandingThresholdElevationAccuraryComplianceFlag { get; set; } = null!;
